...
#TODO - First I must import the blueprint object and all other necessary imports
from flask import render_template, redirect, flash, g, session
from sqlalchemy.exc import IntegrityError #NOTE - This is used to handle the IntegrityError that is raised when a user tries to create an account with a username or email that already exists in the database
